...
$sz_recipes_rands = lekerdezes($db, "select * from sz_recipes where category = 'ebed' and sz_recipes.show = '1' order by rand() limit 5");
...
<body>
  ...
  <main class="tartalom">
    ...
    <article id="munkalap1ebed">
      <article id="munkalap3ebed">
