...
$sz_recipes_rand1 = lekerdezes($db,"select * from sz_recipes order by rand() limit 10");
$sz_recipes_rand2 = lekerdezes($db,"select * from sz_recipes order by rand() limit 10");
$sz_recipes_rand3 = lekerdezes($db,"select * from sz_recipes order by rand() limit 10");
$sz_recipes_rand4 = lekerdezes($db,"select * from sz_recipes order by rand() limit 10");
$sz_recipes_rand5 = lekerdezes($db,"select * from sz_recipes order by rand() limit 10");
...
<?php if ($sz_recipes_rand1['slidepic'] != ''){ ?>
...
<a href="recipes.php?id=<?= $sz_recipes_rand3['id'] ?>"><img src="media/<?php echo($sz_recipes_rand3['image']) ?>"></a>
    ...
    <div class="mySlides fade">
    <?php foreach($sz_recipes_rand4 as $sz_recipes_rand2); ?>
