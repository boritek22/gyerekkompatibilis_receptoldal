...
$sz_recipes_rand1 = lekerdezes($db, "select * from sz_recipes where image <> '' and category = 'szulinap' order by rand() limit 1");
$sz_recipes_rand2 = lekerdezes($db, "select * from sz_recipes where image <> '' and category = 'szulinap' order by rand() limit 1");
$sz_recipes_rand3 = lekerdezes($db, "select * from sz_recipes where image <> '' and category = 'szulinap' order by rand() limit 1");
$sz_recipes_rand4 = lekerdezes($db, "select * from sz_recipes where image <> '' and category = 'szulinap' order by rand() limit 1");
$sz_recipes_rand5 = lekerdezes($db, "select * from sz_recipes where image <> '' and category = 'szulinap' order by rand() limit 1");
            ...
            <article id="munkalap3szulinap">
                ...
                <div style="margin-left: 2%; display: flex; flex-wrap: wrap;">
                    ...
                    foreach ($sz_recipes as $sz_recipe) {
                        if ($sz_recipe['category'] == 'szulinapi') {
