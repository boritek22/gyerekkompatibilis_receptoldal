...
$sz_recipes_rands = lekerdezes($db, "select * from sz_recipes where category = 'ital' and sz_recipes.show = '1' order by rand() limit 5");
...
<body>
  ...
  <main class="tartalom">
    ...
    <article id="munkalap1italok">
      <article id="munkalap3italok">
        <h1 style="text-align:center">Italok</h1>
