...
$sz_recipes_rand1 = lekerdezes($db, "select * from sz_recipes where image <> '' and category = 'szilveszter' order by rand() limit 1");
$sz_recipes_rand2 = lekerdezes($db, "select * from sz_recipes where image <> '' and category = 'szilveszter' order by rand() limit 1");
$sz_recipes_rand3 = lekerdezes($db, "select * from sz_recipes where image <> '' and category = 'szilveszter' order by rand() limit 1");
$sz_recipes_rand4 = lekerdezes($db, "select * from sz_recipes where image <> '' and category = 'szilveszter' order by rand() limit 1");
$sz_recipes_rand5 = lekerdezes($db, "select * from sz_recipes where image <> '' and category = 'szilveszter' order by rand() limit 1");
    ...
    <div class="slideshow-container">
        ...
        <div class="mySlides fade">
            <?php foreach ($sz_recipes_rand1 as $sz_recipes_rand1) {
                if ($sz_recipesrand1 != '' || $sz_recipes_rand1 != NULL) { ?>
...
<body>
    ...
    <main style="color: black" class="tartalom">
        ...
        <article id="munkalap1szilveszter">
            <article id="munkalap3szilveszter">
                <h1 style="text-align:center">Szilveszter</h1>

                <div style="margin-left: 2%; display: flex; flex-wrap: wrap;">
                    <?php
                    foreach ($sz_recipes as $sz_recipe) {
                        if ($sz_recipe['category'] == 'szilveszteri') {
