...
$sz_recipes_rands = lekerdezes($db, "select * from sz_recipes where sz_recipes.show = 1 order by rand() limit 5");
              ...
              <?php foreach ($sz_recipes1 as $sz_recipe1) {
                if ($sz_recipe1['image'] != NULL) { ?>
                  <div style="display: flex">
                    <a href="recipes.php?id=<?= $sz_recipe1['id'] ?>"><img onerror="this.onerror=null; this.src='media/default.jpg'" alt="" class="receptkep" style="max-width: 200px" src="media/<?php echo ($sz_recipe1['image']) ?>" onerror="this.onerror=null; this.src='default.jpg'" alt="">
