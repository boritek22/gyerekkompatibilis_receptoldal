...
$sz_recipes_rands = lekerdezes($db, "select * from sz_recipes where category = 'edesseg' and sz_recipes.show = '1' order by rand() limit 5");
    ...
    <?php foreach ($sz_recipes_rands as $sz_recipes_rand) { ?>
      <div class="mySlides fade">
        <?php if ($sz_recipes_rand['image'] != NULL) { ?>
          <a href="recipes.php?id=<?= $sz_recipes_rand['id'] ?>"><img onerror="this.onerror=null; this.src='media/defaultslide.jpg'" alt="" style="height: 350px; width: 100%;" src="media/<?php echo ($sz_recipes_rand['image']) ?>" onerror="this.onerror=null; this.src='media/default.jpg'" alt=""></a>
...
<body>
  ...
  <main class="tartalom">
    ...
    <article id="munkalap1edesseg">
      <article id="munkalap3edesseg">
        <h1 style="text-align:center;">Édességek</h1>
          ...
          if ($userAdmin == 1) { ?>
            ...
            <div style="margin-left: 2%; display: flex; flex-wrap: wrap;">
              <?php foreach ($sz_recipes1 as $sz_recipe1) {
                if ($sz_recipe1['category'] == 'edesseg') {
            ...
            <div style="margin-left: 2%; display: flex; flex-wrap: wrap;">
              ...
              <?php foreach ($sz_recipes0 as $sz_recipe0) {
                if ($sz_recipe0['category'] == 'edesseg') {
