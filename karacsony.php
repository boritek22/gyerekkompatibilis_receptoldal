...
$sz_recipes_rands = lekerdezes($db, "select * from sz_recipes where category = 'karacsonyi' and sz_recipes.show = '1' order by rand() limit 5");
          ...
          if ($userAdmin == 1) { ?>
            ...
            <div style="margin-left: 2%; display: flex; flex-wrap: wrap;">
              <?php foreach ($sz_recipes1 as $sz_recipe1) {
                if ($sz_recipe1['category'] == 'karacsonyi') {
            ...
            <div style="margin-left: 2%; display: flex; flex-wrap: wrap;">
              <?php foreach ($sz_recipes0 as $sz_recipe0) {
                if ($sz_recipe0['category'] == 'karacsonyi') {
