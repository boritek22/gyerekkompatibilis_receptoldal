...
$sz_recipes_rands = lekerdezes($db, "select * from sz_recipes where category = 'sossag' and sz_recipes.show = '1' order by rand() limit 5");
...
<body>
  ...
  <main class="tartalom">
    ...
    <article id="munkalap1sossag">
      <article id="munkalap3sossag">
        <h1 style="text-align:center">Sós finomságok</h1>
